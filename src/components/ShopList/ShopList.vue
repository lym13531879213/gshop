    ...
    <ul class="shop_list"> 
      <li class="shop_li border-1px"> 
       ...
       <li class="shop_li border-1px"> 
        <a>
          <div class="shop_left"> 
            <img class="shop_img" src="./shop/2.jpg"> 
          </div> 
          <div class="shop_right"> 
            <section class="shop_detail_header"> 
              <h4 class="shop_title" >汗滴禾下土</h4> 
              <ul class="shop_detail_ul"> 
                <li class="supports">保</li> 
                <li class="supports">准</li> 
                <li class="supports">票</li> 
            ...
            <section class="shop_rating_order"> 
              <section class="shop_rating_order_left"> 
                ...
                <div class="rating_section"> 4.2 </div> 
                <div class="order_section"> 月售 106 单 </div> 
              </section> 
              <section class="shop_rating_order_right"> 
                <span class="delivery_style delivery_left">硅谷专送</span> 
       ...
       <li class="shop_li border-1px"> 
        <a>
          <div class="shop_left"> 
            <img class="shop_img" src="./shop/3.jpg"> 
          </div> 
          <div class="shop_right"> 
            <section class="shop_detail_header"> 
              <h4 class="shop_title" >锄禾日当午，汗滴禾下土</h4> 
       ...
       <li class="shop_li border-1px"> 
        <a>
          <div class="shop_left"> 
            <img class="shop_img" src="./shop/4.jpg"> 
          </div> 
          <div class="shop_right"> 
            <section class="shop_detail_header"> 
              <h4 class="shop_title" >锄禾日当午，汗滴禾下土</h4> 
